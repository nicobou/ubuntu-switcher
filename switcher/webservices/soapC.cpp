...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.4 2013-06-20 15:36:41 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_switcher__pow:
		return soap_in_switcher__pow(soap, NULL, NULL, "switcher:pow");
	case SOAP_TYPE_switcher__powResponse:
		return soap_in_switcher__powResponse(soap, NULL, NULL, "switcher:powResponse");
	case SOAP_TYPE_switcher__div:
		return soap_in_switcher__div(soap, NULL, NULL, "switcher:div");
	case SOAP_TYPE_switcher__divResponse:
		return soap_in_switcher__divResponse(soap, NULL, NULL, "switcher:divResponse");
	case SOAP_TYPE_switcher__mul:
		return soap_in_switcher__mul(soap, NULL, NULL, "switcher:mul");
	case SOAP_TYPE_switcher__mulResponse:
		return soap_in_switcher__mulResponse(soap, NULL, NULL, "switcher:mulResponse");
	case SOAP_TYPE_switcher__sub:
		return soap_in_switcher__sub(soap, NULL, NULL, "switcher:sub");
	case SOAP_TYPE_switcher__subResponse:
		return soap_in_switcher__subResponse(soap, NULL, NULL, "switcher:subResponse");
	case SOAP_TYPE_switcher__add:
		return soap_in_switcher__add(soap, NULL, NULL, "switcher:add");
	case SOAP_TYPE_switcher__addResponse:
		return soap_in_switcher__addResponse(soap, NULL, NULL, "switcher:addResponse");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "switcher:pow"))
		{	*type = SOAP_TYPE_switcher__pow;
			return soap_in_switcher__pow(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:powResponse"))
		{	*type = SOAP_TYPE_switcher__powResponse;
			return soap_in_switcher__powResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:div"))
		{	*type = SOAP_TYPE_switcher__div;
			return soap_in_switcher__div(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:divResponse"))
		{	*type = SOAP_TYPE_switcher__divResponse;
			return soap_in_switcher__divResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:mul"))
		{	*type = SOAP_TYPE_switcher__mul;
			return soap_in_switcher__mul(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:mulResponse"))
		{	*type = SOAP_TYPE_switcher__mulResponse;
			return soap_in_switcher__mulResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:sub"))
		{	*type = SOAP_TYPE_switcher__sub;
			return soap_in_switcher__sub(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:subResponse"))
		{	*type = SOAP_TYPE_switcher__subResponse;
			return soap_in_switcher__subResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:add"))
		{	*type = SOAP_TYPE_switcher__add;
			return soap_in_switcher__add(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "switcher:addResponse"))
		{	*type = SOAP_TYPE_switcher__addResponse;
			return soap_in_switcher__addResponse(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_switcher__pow:
		return soap_out_switcher__pow(soap, tag, id, (const struct switcher__pow *)ptr, "switcher:pow");
	case SOAP_TYPE_switcher__powResponse:
		return soap_out_switcher__powResponse(soap, tag, id, (const struct switcher__powResponse *)ptr, "switcher:powResponse");
	case SOAP_TYPE_switcher__div:
		return soap_out_switcher__div(soap, tag, id, (const struct switcher__div *)ptr, "switcher:div");
	case SOAP_TYPE_switcher__divResponse:
		return soap_out_switcher__divResponse(soap, tag, id, (const struct switcher__divResponse *)ptr, "switcher:divResponse");
	case SOAP_TYPE_switcher__mul:
		return soap_out_switcher__mul(soap, tag, id, (const struct switcher__mul *)ptr, "switcher:mul");
	case SOAP_TYPE_switcher__mulResponse:
		return soap_out_switcher__mulResponse(soap, tag, id, (const struct switcher__mulResponse *)ptr, "switcher:mulResponse");
	case SOAP_TYPE_switcher__sub:
		return soap_out_switcher__sub(soap, tag, id, (const struct switcher__sub *)ptr, "switcher:sub");
	case SOAP_TYPE_switcher__subResponse:
		return soap_out_switcher__subResponse(soap, tag, id, (const struct switcher__subResponse *)ptr, "switcher:subResponse");
	case SOAP_TYPE_switcher__add:
		return soap_out_switcher__add(soap, tag, id, (const struct switcher__add *)ptr, "switcher:add");
	case SOAP_TYPE_switcher__addResponse:
		return soap_out_switcher__addResponse(soap, tag, id, (const struct switcher__addResponse *)ptr, "switcher:addResponse");
	case SOAP_TYPE_PointerTobool:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_switcher__get_factory_capabilitiesResponse:
		...
		break;
	case SOAP_TYPE_switcher__pow:
		soap_serialize_switcher__pow(soap, (const struct switcher__pow *)ptr);
		break;
	case SOAP_TYPE_switcher__powResponse:
		soap_serialize_switcher__powResponse(soap, (const struct switcher__powResponse *)ptr);
		break;
	case SOAP_TYPE_switcher__div:
		soap_serialize_switcher__div(soap, (const struct switcher__div *)ptr);
		break;
	case SOAP_TYPE_switcher__divResponse:
		soap_serialize_switcher__divResponse(soap, (const struct switcher__divResponse *)ptr);
		break;
	case SOAP_TYPE_switcher__mul:
		soap_serialize_switcher__mul(soap, (const struct switcher__mul *)ptr);
		break;
	case SOAP_TYPE_switcher__mulResponse:
		soap_serialize_switcher__mulResponse(soap, (const struct switcher__mulResponse *)ptr);
		break;
	case SOAP_TYPE_switcher__sub:
		soap_serialize_switcher__sub(soap, (const struct switcher__sub *)ptr);
		break;
	case SOAP_TYPE_switcher__subResponse:
		soap_serialize_switcher__subResponse(soap, (const struct switcher__subResponse *)ptr);
		break;
	case SOAP_TYPE_switcher__add:
		soap_serialize_switcher__add(soap, (const struct switcher__add *)ptr);
		break;
	case SOAP_TYPE_switcher__addResponse:
		soap_serialize_switcher__addResponse(soap, (const struct switcher__addResponse *)ptr);
		break;
	case SOAP_TYPE_PointerTobool:
...
{	(void)type;
	...
	{
	case SOAP_TYPE_switcher__addResponse:
		return (void*)soap_instantiate_switcher__addResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__add:
		return (void*)soap_instantiate_switcher__add(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__subResponse:
		return (void*)soap_instantiate_switcher__subResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__sub:
		return (void*)soap_instantiate_switcher__sub(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__mulResponse:
		return (void*)soap_instantiate_switcher__mulResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__mul:
		return (void*)soap_instantiate_switcher__mul(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__divResponse:
		return (void*)soap_instantiate_switcher__divResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__div:
		return (void*)soap_instantiate_switcher__div(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__powResponse:
		return (void*)soap_instantiate_switcher__powResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_switcher__pow:
		return (void*)soap_instantiate_switcher__pow(soap, -1, type, arrayType, n);
	case SOAP_TYPE_std__string:
...
{	switch (p->type)
	...
	case SOAP_TYPE_switcher__addResponse:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__addResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__addResponse*)p->ptr);
		break;
	case SOAP_TYPE_switcher__add:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__add*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__add*)p->ptr);
		break;
	case SOAP_TYPE_switcher__subResponse:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__subResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__subResponse*)p->ptr);
		break;
	case SOAP_TYPE_switcher__sub:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__sub*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__sub*)p->ptr);
		break;
	case SOAP_TYPE_switcher__mulResponse:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__mulResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__mulResponse*)p->ptr);
		break;
	case SOAP_TYPE_switcher__mul:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__mul*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__mul*)p->ptr);
		break;
	case SOAP_TYPE_switcher__divResponse:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__divResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__divResponse*)p->ptr);
		break;
	case SOAP_TYPE_switcher__div:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__div*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__div*)p->ptr);
		break;
	case SOAP_TYPE_switcher__powResponse:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__powResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__powResponse*)p->ptr);
		break;
	case SOAP_TYPE_switcher__pow:
		if (p->size < 0)
			SOAP_DELETE((struct switcher__pow*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct switcher__pow*)p->ptr);
		break;
	case SOAP_TYPE_std__string:
		if (p->size < 0)
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTobool(soap, &a->result);
}
...
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__invoke_methodResponse), type))
		return soap->error;
	if (soap_out_PointerTobool(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_result && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTobool(soap, "result", &a->result, "xsd:boolean"))
				{	soap_flag_result--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__pow(struct soap *soap, struct switcher__pow *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__pow(struct soap *soap, const struct switcher__pow *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__pow(struct soap *soap, const char *tag, int id, const struct switcher__pow *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__pow), type))
		return soap->error;
...
SOAP_FMAC3 struct switcher__pow * SOAP_FMAC4 soap_in_switcher__pow(struct soap *soap, const char *tag, struct switcher__pow *a, const char *type)
{
	size_t soap_flag_a = 1;
	size_t soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__pow *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__pow, sizeof(struct switcher__pow), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__pow(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__pow *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__pow, 0, sizeof(struct switcher__pow), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__pow(struct soap *soap, const struct switcher__pow *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__pow);
	if (soap_out_switcher__pow(soap, tag?tag:"switcher:pow", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__pow * SOAP_FMAC4 soap_get_switcher__pow(struct soap *soap, struct switcher__pow *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__pow(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__pow * SOAP_FMAC2 soap_instantiate_switcher__pow(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__pow(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__pow, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__pow);
		if (size)
			*size = sizeof(struct switcher__pow);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__pow[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__pow);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__pow*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__pow(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__pow %p -> %p\n", q, p));
	*(struct switcher__pow*)p = *(struct switcher__pow*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__powResponse(struct soap *soap, struct switcher__powResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__powResponse(struct soap *soap, const struct switcher__powResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__powResponse(struct soap *soap, const char *tag, int id, const struct switcher__powResponse *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__powResponse), type))
		return soap->error;
...
SOAP_FMAC3 struct switcher__powResponse * SOAP_FMAC4 soap_in_switcher__powResponse(struct soap *soap, const char *tag, struct switcher__powResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__powResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__powResponse, sizeof(struct switcher__powResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__powResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__powResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__powResponse, 0, sizeof(struct switcher__powResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__powResponse(struct soap *soap, const struct switcher__powResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__powResponse);
	if (soap_out_switcher__powResponse(soap, tag?tag:"switcher:powResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__powResponse * SOAP_FMAC4 soap_get_switcher__powResponse(struct soap *soap, struct switcher__powResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__powResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__powResponse * SOAP_FMAC2 soap_instantiate_switcher__powResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__powResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__powResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__powResponse);
		if (size)
			*size = sizeof(struct switcher__powResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__powResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__powResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__powResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__powResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__powResponse %p -> %p\n", q, p));
	*(struct switcher__powResponse*)p = *(struct switcher__powResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__div(struct soap *soap, struct switcher__div *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_double(soap, &a->a);
	soap_default_double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__div(struct soap *soap, const struct switcher__div *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->a, SOAP_TYPE_double);
	soap_embedded(soap, &a->b, SOAP_TYPE_double);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__div(struct soap *soap, const char *tag, int id, const struct switcher__div *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__div), type))
		return soap->error;
	if (soap_out_double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct switcher__div * SOAP_FMAC4 soap_in_switcher__div(struct soap *soap, const char *tag, struct switcher__div *a, const char *type)
{
	size_t soap_flag_a = 1;
	size_t soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__div *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__div, sizeof(struct switcher__div), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__div(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__div *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__div, 0, sizeof(struct switcher__div), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__div(struct soap *soap, const struct switcher__div *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__div);
	if (soap_out_switcher__div(soap, tag?tag:"switcher:div", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__div * SOAP_FMAC4 soap_get_switcher__div(struct soap *soap, struct switcher__div *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__div(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__div * SOAP_FMAC2 soap_instantiate_switcher__div(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__div(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__div, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__div);
		if (size)
			*size = sizeof(struct switcher__div);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__div[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__div);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__div*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__div(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__div %p -> %p\n", q, p));
	*(struct switcher__div*)p = *(struct switcher__div*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__divResponse(struct soap *soap, struct switcher__divResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__divResponse(struct soap *soap, const struct switcher__divResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__divResponse(struct soap *soap, const char *tag, int id, const struct switcher__divResponse *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__divResponse), type))
		return soap->error;
	if (soap_out_PointerTodouble(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct switcher__divResponse * SOAP_FMAC4 soap_in_switcher__divResponse(struct soap *soap, const char *tag, struct switcher__divResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__divResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__divResponse, sizeof(struct switcher__divResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__divResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__divResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__divResponse, 0, sizeof(struct switcher__divResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__divResponse(struct soap *soap, const struct switcher__divResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__divResponse);
	if (soap_out_switcher__divResponse(soap, tag?tag:"switcher:divResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__divResponse * SOAP_FMAC4 soap_get_switcher__divResponse(struct soap *soap, struct switcher__divResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__divResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__divResponse * SOAP_FMAC2 soap_instantiate_switcher__divResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__divResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__divResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__divResponse);
		if (size)
			*size = sizeof(struct switcher__divResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__divResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__divResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__divResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__divResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__divResponse %p -> %p\n", q, p));
	*(struct switcher__divResponse*)p = *(struct switcher__divResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__mul(struct soap *soap, struct switcher__mul *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_double(soap, &a->a);
	soap_default_double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__mul(struct soap *soap, const struct switcher__mul *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->a, SOAP_TYPE_double);
	soap_embedded(soap, &a->b, SOAP_TYPE_double);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__mul(struct soap *soap, const char *tag, int id, const struct switcher__mul *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__mul), type))
		return soap->error;
	if (soap_out_double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct switcher__mul * SOAP_FMAC4 soap_in_switcher__mul(struct soap *soap, const char *tag, struct switcher__mul *a, const char *type)
{
	size_t soap_flag_a = 1;
	size_t soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__mul *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__mul, sizeof(struct switcher__mul), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__mul(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__mul *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__mul, 0, sizeof(struct switcher__mul), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__mul(struct soap *soap, const struct switcher__mul *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__mul);
	if (soap_out_switcher__mul(soap, tag?tag:"switcher:mul", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__mul * SOAP_FMAC4 soap_get_switcher__mul(struct soap *soap, struct switcher__mul *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__mul(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__mul * SOAP_FMAC2 soap_instantiate_switcher__mul(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__mul(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__mul, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__mul);
		if (size)
			*size = sizeof(struct switcher__mul);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__mul[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__mul);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__mul*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__mul(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__mul %p -> %p\n", q, p));
	*(struct switcher__mul*)p = *(struct switcher__mul*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__mulResponse(struct soap *soap, struct switcher__mulResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__mulResponse(struct soap *soap, const struct switcher__mulResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__mulResponse(struct soap *soap, const char *tag, int id, const struct switcher__mulResponse *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__mulResponse), type))
		return soap->error;
	if (soap_out_PointerTodouble(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct switcher__mulResponse * SOAP_FMAC4 soap_in_switcher__mulResponse(struct soap *soap, const char *tag, struct switcher__mulResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__mulResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__mulResponse, sizeof(struct switcher__mulResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__mulResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__mulResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__mulResponse, 0, sizeof(struct switcher__mulResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__mulResponse(struct soap *soap, const struct switcher__mulResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__mulResponse);
	if (soap_out_switcher__mulResponse(soap, tag?tag:"switcher:mulResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__mulResponse * SOAP_FMAC4 soap_get_switcher__mulResponse(struct soap *soap, struct switcher__mulResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__mulResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__mulResponse * SOAP_FMAC2 soap_instantiate_switcher__mulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__mulResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__mulResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__mulResponse);
		if (size)
			*size = sizeof(struct switcher__mulResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__mulResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__mulResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__mulResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__mulResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__mulResponse %p -> %p\n", q, p));
	*(struct switcher__mulResponse*)p = *(struct switcher__mulResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__sub(struct soap *soap, struct switcher__sub *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_double(soap, &a->a);
	soap_default_double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__sub(struct soap *soap, const struct switcher__sub *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->a, SOAP_TYPE_double);
	soap_embedded(soap, &a->b, SOAP_TYPE_double);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__sub(struct soap *soap, const char *tag, int id, const struct switcher__sub *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__sub), type))
		return soap->error;
	if (soap_out_double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct switcher__sub * SOAP_FMAC4 soap_in_switcher__sub(struct soap *soap, const char *tag, struct switcher__sub *a, const char *type)
{
	size_t soap_flag_a = 1;
	size_t soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__sub *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__sub, sizeof(struct switcher__sub), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__sub(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__sub *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__sub, 0, sizeof(struct switcher__sub), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__sub(struct soap *soap, const struct switcher__sub *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__sub);
	if (soap_out_switcher__sub(soap, tag?tag:"switcher:sub", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__sub * SOAP_FMAC4 soap_get_switcher__sub(struct soap *soap, struct switcher__sub *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__sub(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__sub * SOAP_FMAC2 soap_instantiate_switcher__sub(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__sub(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__sub, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__sub);
		if (size)
			*size = sizeof(struct switcher__sub);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__sub[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__sub);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__sub*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__sub(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__sub %p -> %p\n", q, p));
	*(struct switcher__sub*)p = *(struct switcher__sub*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__subResponse(struct soap *soap, struct switcher__subResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__subResponse(struct soap *soap, const struct switcher__subResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__subResponse(struct soap *soap, const char *tag, int id, const struct switcher__subResponse *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__subResponse), type))
		return soap->error;
	if (soap_out_PointerTodouble(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct switcher__subResponse * SOAP_FMAC4 soap_in_switcher__subResponse(struct soap *soap, const char *tag, struct switcher__subResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__subResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__subResponse, sizeof(struct switcher__subResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__subResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__subResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__subResponse, 0, sizeof(struct switcher__subResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__subResponse(struct soap *soap, const struct switcher__subResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__subResponse);
	if (soap_out_switcher__subResponse(soap, tag?tag:"switcher:subResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__subResponse * SOAP_FMAC4 soap_get_switcher__subResponse(struct soap *soap, struct switcher__subResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__subResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__subResponse * SOAP_FMAC2 soap_instantiate_switcher__subResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__subResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__subResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__subResponse);
		if (size)
			*size = sizeof(struct switcher__subResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__subResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__subResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__subResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__subResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__subResponse %p -> %p\n", q, p));
	*(struct switcher__subResponse*)p = *(struct switcher__subResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__add(struct soap *soap, struct switcher__add *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_double(soap, &a->a);
	soap_default_double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__add(struct soap *soap, const struct switcher__add *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->a, SOAP_TYPE_double);
	soap_embedded(soap, &a->b, SOAP_TYPE_double);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__add(struct soap *soap, const char *tag, int id, const struct switcher__add *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__add), type))
		return soap->error;
	if (soap_out_double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct switcher__add * SOAP_FMAC4 soap_in_switcher__add(struct soap *soap, const char *tag, struct switcher__add *a, const char *type)
{
	size_t soap_flag_a = 1;
	size_t soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__add *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__add, sizeof(struct switcher__add), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__add(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__add *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__add, 0, sizeof(struct switcher__add), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__add(struct soap *soap, const struct switcher__add *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__add);
	if (soap_out_switcher__add(soap, tag?tag:"switcher:add", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__add * SOAP_FMAC4 soap_get_switcher__add(struct soap *soap, struct switcher__add *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__add(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__add * SOAP_FMAC2 soap_instantiate_switcher__add(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__add(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__add, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__add);
		if (size)
			*size = sizeof(struct switcher__add);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__add[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__add);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__add*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__add(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__add %p -> %p\n", q, p));
	*(struct switcher__add*)p = *(struct switcher__add*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_switcher__addResponse(struct soap *soap, struct switcher__addResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_switcher__addResponse(struct soap *soap, const struct switcher__addResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTodouble(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_switcher__addResponse(struct soap *soap, const char *tag, int id, const struct switcher__addResponse *a, const char *type)
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_switcher__addResponse), type))
		return soap->error;
	if (soap_out_PointerTodouble(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct switcher__addResponse * SOAP_FMAC4 soap_in_switcher__addResponse(struct soap *soap, const char *tag, struct switcher__addResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct switcher__addResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_switcher__addResponse, sizeof(struct switcher__addResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_switcher__addResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct switcher__addResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_switcher__addResponse, 0, sizeof(struct switcher__addResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_switcher__addResponse(struct soap *soap, const struct switcher__addResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_switcher__addResponse);
	if (soap_out_switcher__addResponse(soap, tag?tag:"switcher:addResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct switcher__addResponse * SOAP_FMAC4 soap_get_switcher__addResponse(struct soap *soap, struct switcher__addResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_switcher__addResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct switcher__addResponse * SOAP_FMAC2 soap_instantiate_switcher__addResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_switcher__addResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_switcher__addResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__addResponse);
		if (size)
			*size = sizeof(struct switcher__addResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct switcher__addResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct switcher__addResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct switcher__addResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_switcher__addResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct switcher__addResponse %p -> %p\n", q, p));
	*(struct switcher__addResponse*)p = *(struct switcher__addResponse*)q;
}
