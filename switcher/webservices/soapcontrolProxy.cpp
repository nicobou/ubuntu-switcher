...
int controlProxy::add(const char *endpoint, const char *soap_action, double a, double b, double *result)
{	struct soap *soap = this;
	...
	soap->encodingStyle = "";
	soap_tmp_switcher__add.a = a;
	soap_tmp_switcher__add.b = b;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_switcher__add(soap, &soap_tmp_switcher__add);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_switcher__add(soap, &soap_tmp_switcher__add, "switcher:add", NULL)
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__addResponse = soap_get_switcher__addResponse(soap, NULL, "", "");
	if (soap->error)
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__addResponse->result)
		*result = *soap_tmp_switcher__addResponse->result;
	return soap_closesock(soap);
}

int controlProxy::sub(const char *endpoint, const char *soap_action, double a, double b, double *result)
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://localhost:8080/switcher-control.cgi";
	soap->encodingStyle = "";
	soap_tmp_switcher__sub.a = a;
	soap_tmp_switcher__sub.b = b;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_switcher__sub(soap, &soap_tmp_switcher__sub);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__sub(soap, &soap_tmp_switcher__sub, "switcher:sub", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__subResponse = soap_get_switcher__subResponse(soap, NULL, "", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__subResponse->result)
		*result = *soap_tmp_switcher__subResponse->result;
	return soap_closesock(soap);
}

int controlProxy::mul(const char *endpoint, const char *soap_action, double a, double b, double *result)
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://localhost:8080/switcher-control.cgi";
	soap->encodingStyle = "";
	soap_tmp_switcher__mul.a = a;
	soap_tmp_switcher__mul.b = b;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_switcher__mul(soap, &soap_tmp_switcher__mul);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__mul(soap, &soap_tmp_switcher__mul, "switcher:mul", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__mulResponse = soap_get_switcher__mulResponse(soap, NULL, "", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__mulResponse->result)
		*result = *soap_tmp_switcher__mulResponse->result;
	return soap_closesock(soap);
}

int controlProxy::div(const char *endpoint, const char *soap_action, double a, double b, double *result)
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://localhost:8080/switcher-control.cgi";
	soap->encodingStyle = "";
	soap_tmp_switcher__div.a = a;
	soap_tmp_switcher__div.b = b;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_switcher__div(soap, &soap_tmp_switcher__div);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__div(soap, &soap_tmp_switcher__div, "switcher:div", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__divResponse = soap_get_switcher__divResponse(soap, NULL, "", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__divResponse->result)
		*result = *soap_tmp_switcher__divResponse->result;
	return soap_closesock(soap);
}

int controlProxy::pow(const char *endpoint, const char *soap_action, double a, double b, double *result)
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://localhost:8080/switcher-control.cgi";
	soap->encodingStyle = "";
	soap_tmp_switcher__pow.a = a;
	soap_tmp_switcher__pow.b = b;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_switcher__pow(soap, &soap_tmp_switcher__pow);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__pow(soap, &soap_tmp_switcher__pow, "switcher:pow", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__powResponse = soap_get_switcher__powResponse(soap, NULL, "", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__powResponse->result)
		*result = *soap_tmp_switcher__powResponse->result;
	return soap_closesock(soap);
}
...
int controlProxy::invoke_method(const char *endpoint, const char *soap_action, std::string quiddity_name, std::string method_name, std::vector<std::string >args, bool *result)
{	struct soap *soap = this;
