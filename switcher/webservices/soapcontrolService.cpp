...
static int serve_switcher__add(controlService*);
static int serve_switcher__sub(controlService*);
static int serve_switcher__mul(controlService*);
static int serve_switcher__div(controlService*);
static int serve_switcher__pow(controlService*);
...
{	soap_peek_element(this);
	if (!soap_match_tag(this, this->tag, "switcher:add"))
		return serve_switcher__add(this);
	if (!soap_match_tag(this, this->tag, "switcher:sub"))
		return serve_switcher__sub(this);
	if (!soap_match_tag(this, this->tag, "switcher:mul"))
		return serve_switcher__mul(this);
	if (!soap_match_tag(this, this->tag, "switcher:div"))
		return serve_switcher__div(this);
	if (!soap_match_tag(this, this->tag, "switcher:pow"))
		return serve_switcher__pow(this);
...
static int serve_switcher__add(controlService *soap)
{	struct switcher__add soap_tmp_switcher__add;
	struct switcher__addResponse soap_tmp_switcher__addResponse;
	double soap_tmp_double;
	soap_default_switcher__addResponse(soap, &soap_tmp_switcher__addResponse);
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_switcher__addResponse.result = &soap_tmp_double;
	soap_default_switcher__add(soap, &soap_tmp_switcher__add);
	soap->encodingStyle = "";
	if (!soap_get_switcher__add(soap, &soap_tmp_switcher__add, "switcher:add", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->add(soap_tmp_switcher__add.a, soap_tmp_switcher__add.b, soap_tmp_switcher__addResponse.result);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_switcher__addResponse(soap, &soap_tmp_switcher__addResponse);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_switcher__addResponse(soap, &soap_tmp_switcher__addResponse, "switcher:addResponse", NULL)
...
static int serve_switcher__sub(controlService *soap)
{	struct switcher__sub soap_tmp_switcher__sub;
	struct switcher__subResponse soap_tmp_switcher__subResponse;
	double soap_tmp_double;
	soap_default_switcher__subResponse(soap, &soap_tmp_switcher__subResponse);
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_switcher__subResponse.result = &soap_tmp_double;
	soap_default_switcher__sub(soap, &soap_tmp_switcher__sub);
	soap->encodingStyle = "";
	if (!soap_get_switcher__sub(soap, &soap_tmp_switcher__sub, "switcher:sub", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->sub(soap_tmp_switcher__sub.a, soap_tmp_switcher__sub.b, soap_tmp_switcher__subResponse.result);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_switcher__subResponse(soap, &soap_tmp_switcher__subResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__subResponse(soap, &soap_tmp_switcher__subResponse, "switcher:subResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_switcher__mul(controlService *soap)
{	struct switcher__mul soap_tmp_switcher__mul;
	struct switcher__mulResponse soap_tmp_switcher__mulResponse;
	double soap_tmp_double;
	soap_default_switcher__mulResponse(soap, &soap_tmp_switcher__mulResponse);
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_switcher__mulResponse.result = &soap_tmp_double;
	soap_default_switcher__mul(soap, &soap_tmp_switcher__mul);
	soap->encodingStyle = "";
	if (!soap_get_switcher__mul(soap, &soap_tmp_switcher__mul, "switcher:mul", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->mul(soap_tmp_switcher__mul.a, soap_tmp_switcher__mul.b, soap_tmp_switcher__mulResponse.result);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_switcher__mulResponse(soap, &soap_tmp_switcher__mulResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__mulResponse(soap, &soap_tmp_switcher__mulResponse, "switcher:mulResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_switcher__div(controlService *soap)
{	struct switcher__div soap_tmp_switcher__div;
	struct switcher__divResponse soap_tmp_switcher__divResponse;
	double soap_tmp_double;
	soap_default_switcher__divResponse(soap, &soap_tmp_switcher__divResponse);
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_switcher__divResponse.result = &soap_tmp_double;
	soap_default_switcher__div(soap, &soap_tmp_switcher__div);
	soap->encodingStyle = "";
	if (!soap_get_switcher__div(soap, &soap_tmp_switcher__div, "switcher:div", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->div(soap_tmp_switcher__div.a, soap_tmp_switcher__div.b, soap_tmp_switcher__divResponse.result);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_switcher__divResponse(soap, &soap_tmp_switcher__divResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__divResponse(soap, &soap_tmp_switcher__divResponse, "switcher:divResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_switcher__pow(controlService *soap)
{	struct switcher__pow soap_tmp_switcher__pow;
	struct switcher__powResponse soap_tmp_switcher__powResponse;
	double soap_tmp_double;
	soap_default_switcher__powResponse(soap, &soap_tmp_switcher__powResponse);
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_switcher__powResponse.result = &soap_tmp_double;
	soap_default_switcher__pow(soap, &soap_tmp_switcher__pow);
	soap->encodingStyle = "";
	if (!soap_get_switcher__pow(soap, &soap_tmp_switcher__pow, "switcher:pow", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->pow(soap_tmp_switcher__pow.a, soap_tmp_switcher__pow.b, soap_tmp_switcher__powResponse.result);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_switcher__powResponse(soap, &soap_tmp_switcher__powResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__powResponse(soap, &soap_tmp_switcher__powResponse, "switcher:powResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct switcher__invoke_method soap_tmp_switcher__invoke_method;
	...
	soap_tmp_switcher__invoke_methodResponse.result = &soap_tmp_bool;
