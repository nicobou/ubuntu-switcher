...
static int serve_switcher__rename_quiddity(controlService*);
...
{	soap_peek_element(this);
	...
	if (!soap_match_tag(this, this->tag, "switcher:rename-quiddity"))
		return serve_switcher__rename_quiddity(this);
...
static int serve_switcher__rename_quiddity(controlService *soap)
{	struct switcher__rename_quiddity soap_tmp_switcher__rename_quiddity;
	...
	std::string soap_tmp_std__string;
	soap_default_switcher__rename_quiddityResponse(soap, &soap_tmp_switcher__rename_quiddityResponse);
	soap_default_std__string(soap, &soap_tmp_std__string);
	soap_tmp_switcher__rename_quiddityResponse.result = &soap_tmp_std__string;
	soap_default_switcher__rename_quiddity(soap, &soap_tmp_switcher__rename_quiddity);
	if (!soap_get_switcher__rename_quiddity(soap, &soap_tmp_switcher__rename_quiddity, "switcher:rename-quiddity", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->rename_quiddity(soap_tmp_switcher__rename_quiddity.nick_name, soap_tmp_switcher__rename_quiddity.new_nick_name, soap_tmp_switcher__rename_quiddityResponse.result);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = "";
	soap_serializeheader(soap);
	soap_serialize_switcher__rename_quiddityResponse(soap, &soap_tmp_switcher__rename_quiddityResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__rename_quiddityResponse(soap, &soap_tmp_switcher__rename_quiddityResponse, "switcher:rename-quiddityResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
