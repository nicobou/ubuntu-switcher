...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_factory_capabilitiesResponse || soap->error)
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_classes_docResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_quiddity_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_quiddities_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_class_docResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_quiddity_namesResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_properties_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_property_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_properties_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_property_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_propertyResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__create_quiddityResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__create_named_quiddityResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__rename_quiddityResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_methods_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_method_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_methods_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_method_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__invoke_methodResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_signals_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_signal_descriptionResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_signals_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__saveResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__loadResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__runResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct soap *soap = this;
	...
	if (!soap_tmp_switcher__get_signal_description_by_classResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
int controlProxy::get_information_tree(const char *endpoint, const char *soap_action, std::string quiddity_name, std::string path, std::string *result)
{	struct soap *soap = this;
	...
	soap_begin(soap);
	soap->encodingStyle = "";
	soap_tmp_switcher__get_information_tree.quiddity_name = quiddity_name;
	soap_tmp_switcher__get_information_tree.path = path;
	soap_serializeheader(soap);
	soap_serialize_switcher__get_information_tree(soap, &soap_tmp_switcher__get_information_tree);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_switcher__get_information_tree(soap, &soap_tmp_switcher__get_information_tree, "switcher:get-information-tree", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_recv_fault(soap, 1))
		return soap->error;
	soap_tmp_switcher__get_information_treeResponse = soap_get_switcher__get_information_treeResponse(soap, NULL, "", "");
	if (!soap_tmp_switcher__get_information_treeResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (result && soap_tmp_switcher__get_information_treeResponse->result)
		*result = *soap_tmp_switcher__get_information_treeResponse->result;
	return soap_closesock(soap);
}
